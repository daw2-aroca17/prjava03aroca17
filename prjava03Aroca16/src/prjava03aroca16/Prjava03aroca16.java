...
public class Prjava03aroca16 extends Frame 
   ...
   public Prjava03aroca16 () { 
      ...
      setTitle("prjava03aroca16");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava03aroca16();  // Let the construct do the job 
   } 
